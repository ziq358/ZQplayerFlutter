...
class LoadingWidget {
  static Widget create(Widget backBody,
      {bool loading = true, Color bgColor, Color loadingBgColor}) {
    return Stack(
      children: <Widget>[
        backBody,
        Offstage(
          child: getFrontBody(bgColor: bgColor, loadingBgColor: loadingBgColor),
  ...
  static Widget getFrontBody({Color bgColor, Color loadingBgColor}) {
    return Container(
